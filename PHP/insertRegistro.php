...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_query = mysqli_query($conexion, "SELECT boleta FROM alumnos WHERE boleta = '$boleta'");
    ...
    $sql = "INSERT INTO alumnos 
                (boleta, nombre, fecha_nacimiento, genero, curp, entidad_federativa, escuela_procedencia, nombre_escuela, promedio, correo, contrasena, telefono) 
                VALUES 
                ('$boleta', '$nombre', '$fecha_nacimiento', '$genero', '$curp', '$entidad', '$escuela', '$nombre_escuela', '$promedio', '$correo', '$contrasena_hash', '$telefono')";
